# =============================================================================
# DISABLED: one-off exploratory analysis script (NOT part of the Apex app).
#
# This is a standalone research script that simulates a BTC "risk-band push %"
# strategy and renders three blocking matplotlib/seaborn charts via plt.show().
# It is not imported anywhere in the app (the app uses Plotly, not matplotlib/
# seaborn, and seaborn is not in requirements.txt). Despite the *_test.py name
# it contains no pytest tests; its top-level plt.show() calls run on import and
# block, which also hangs `pytest tests/`.
#
# Commented out to stop the pop-up windows and unblock the test suite. To run
# the analysis again, uncomment the body below (and `pip install matplotlib
# seaborn`).
# =============================================================================
