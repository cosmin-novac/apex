...
IMPRESSUM_DE = """
**Angaben gemaess Paragraph 5 DDG (Digitale-Dienste-Gesetz)**
...
**Verantwortlich fuer den Inhalt nach Paragraph 18 Abs. 2 MStV (Medienstaatsvertrag)**
...
IMPRESSUM_EN = """
**Legal Notice according to Paragraph 5 DDG (German Digital Services Act)**
...
**Responsible for content according to Paragraph 18 (2) MStV (German Interstate Media Treaty)**
...
Diese Datenschutzerklaerung erklaert, welche personenbezogenen Daten wir bei der Nutzung von Apex Portfolio ("Apex") verarbeiten, zu welchen Zwecken dies geschieht und welche externen Dienste dabei eingesetzt werden. Wir legen offen, welche Cloud-Dienste beteiligt sind, damit Sie eine informierte Entscheidung treffen koennen.
...
Sie haben nach der DSGVO insbesondere das Recht auf Auskunft, Berichtigung, Loeschung, Einschraenkung der Verarbeitung, Datenuebertragbarkeit sowie Widerspruch gegen bestimmte Verarbeitungen. Soweit eine Verarbeitung auf Einwilligung beruht, koennen Sie diese jederzeit mit Wirkung fuer die Zukunft widerrufen.
...
This Privacy Policy explains which personal data we process when you use Apex Portfolio ("Apex"), for which purposes, and which external services are involved. We disclose every cloud service involved so you can make an informed decision.
...
Under the GDPR, you have rights of access, rectification, deletion, restriction of processing, data portability, and objection to certain processing. Where processing is based on consent, you may withdraw that consent at any time with effect for the future.
